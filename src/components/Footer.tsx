        ...
        <div className="grid grid-cols-[1fr_1fr]">
          <div className="col-start-1 col-end-2 row-start-1 row-end-2">
            <div>
              ...
              <div className="mt-[8px] text-[12px] text-[#7f7f7f] leading-loose">
                <p className="mb-0">
            ...
            <div className="mt-[24px] text-[12px] text-[#7f7f7f] leading-loose">
              <div className="mt-[8px]">
                <b>번개장터(주)더현대서울점</b> | 최재화, 강승현 | 365-85-01581
                <br />
                서울특별시 영등포구 여의대로 108, 지하2층(여의도동, 파크원)
              </div>
              <div className="mt-[8px]">
                <b>번개장터(주)코엑스점</b> | 최재화, 강승현 | 142-85-27412
                <br />
                서울특별시 강남구 영동대로 513, 쇼핑몰동 B1층 C102호(삼성동,
                코엑스)
              </div>
              <div className="mt-[8px]">
                <b>번개장터(주)센터필드점</b> | 최재화, 강승현 | 808-85-01905
                <br />
          ...
          <div className="col-start-2 col-end-3 row-start-1 row-end-2">
            <div className="text-[#666666]">
              <p className="text-[14px] font-bold  mb-0">고객센터</p>
              <div className="mt-[8px] text-xs leading-loose">
                <strong className="text-[25px] leading-none">1670-2910</strong>
                <br />
                운영시간 9시 - 18시 (주말/공휴일 휴무, 점심시간 12시 - 13시)
                <br />
                <div className="flex">
                  <div className="mr-[10px] underline cursor-pointer">
                    공지사항
                  </div>
                  <div className="mr-[10px] underline cursor-pointer">
                    1:1 문의하기
            ...
            <div className="mt-[40px] text-[#666666]">
              <p className="text-[14px] font-bold  mb-0">
                우리은행 채무지급보증 안내
              </p>
              <div className="mt-[8px] text-[12px] leading-loose">
                번개장터㈜는 회사가 직접 판매하는 상품에 한하여, 고객님의 현금
                결제 금액에 대해 우리은행과 채무지급보증 계약을 체결하여
                안전거래를 보장하고 있습니다.
                <br />
                <p className="underline cursor-pointer mb-0">
                  서비스 가입사실 확인
                </p>
